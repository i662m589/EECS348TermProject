...
double conv_str_doub(const char& x) {
    switch(x) {
        case '0': return 0;
        case '1': return 1;
        case '2': return 2;
...
double evaluator(vector<char> &vect) {
    Stack<double> stack;
...
//I still need to work on how I should handle the parenthesis, but this is the basic format